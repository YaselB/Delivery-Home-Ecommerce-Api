...
public class CreateCodeEntityEventHandler : INotificationHandler<CreateCodeEntityEvent>
{
    private readonly ISendEmailService _emailService;
    private readonly ILogger<CreateCodeEntityEventHandler> _logger;

    public CreateCodeEntityEventHandler(ISendEmailService emailService, ILogger<CreateCodeEntityEventHandler> logger)
    {
        _emailService = emailService;
        _logger = logger;
    }

    public async Task Handle(CreateCodeEntityEvent notification, CancellationToken cancellationToken)
    {
        try
        {
