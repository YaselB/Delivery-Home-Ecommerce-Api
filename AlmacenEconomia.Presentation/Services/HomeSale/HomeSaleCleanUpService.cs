...
public class HomeSaleCleanUpService : BackgroundService
{
    private readonly IServiceScopeFactory _serviceScopeFactory;
    private readonly ILogger<ProductEnterCleanupService> _logger;

    public HomeSaleCleanUpService(IServiceScopeFactory serviceScopeFactory, ILogger<ProductEnterCleanupService> logger)
    {
